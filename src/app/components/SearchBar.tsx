    ...
    <form className="flex w-5/12 items-center space-x-2">
      ...
      <div className="relative w-full">
        ...
        <input
          ...
          className="border-1 peer block w-full appearance-none rounded-lg border-gray-300 bg-transparent px-2.5 pb-2.5 pt-4 text-sm text-gray-900 focus:border-blue-600 focus:outline-none focus:ring-0 dark:border-gray-600 dark:text-white"
          placeholder=" " // Placeholder is kept for floating effect
          required
          value={inputUrl}
        ...
        <label
          ...
          className="absolute top-2 z-10 origin-[0] -translate-y-4 scale-75 transform bg-white px-2 text-sm text-gray-500 duration-300 peer-placeholder-shown:top-1/2 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:scale-100 peer-focus:px-2 peer-focus:text-blue-600 dark:bg-gray-900 peer-focus:dark:text-blue-500"
        >
          Website to crawl
        </label>
      </div>
